...
#MODULES="gmm sgmm2"
#MODULES="gmm sgmm2 hmm tree matrix util base"
#MODULES="ivector lat lm decoder feat transform gmm hmm tree matrix util base itf cudamatrix fstext"
#MODULES="ivector lat lm  feat transform gmm hmm tree matrix util base itf cudamatrix fstext"
